...
# Import target "osimJAM" for configuration "Release"
set_property(TARGET osimJAM APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(osimJAM PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/sdk/lib/osimJAM.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/osimJAM.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS osimJAM )
list(APPEND _IMPORT_CHECK_FILES_FOR_osimJAM "${_IMPORT_PREFIX}/sdk/lib/osimJAM.lib" "${_IMPORT_PREFIX}/bin/osimJAM.dll" )
