 ...
 */
public class SetCOMAKCostFunctionParameters extends OpenSimObject {
  private transient long swigCPtr;

  public SetCOMAKCostFunctionParameters(long cPtr, boolean cMemoryOwn) {
    super(opensimJAMJNI.SetCOMAKCostFunctionParameters_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(SetCOMAKCostFunctionParameters obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        opensimJAMJNI.delete_SetCOMAKCostFunctionParameters(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public static SetCOMAKCostFunctionParameters safeDownCast(OpenSimObject obj) {
    long cPtr = opensimJAMJNI.SetCOMAKCostFunctionParameters_safeDownCast(OpenSimObject.getCPtr(obj), obj);
    return (cPtr == 0) ? null : new SetCOMAKCostFunctionParameters(cPtr, false);
  }

  public void assign(OpenSimObject aObject) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_assign(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject);
  }

  public static String getClassName() {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getClassName();
  }

  public OpenSimObject clone() {
    long cPtr = opensimJAMJNI.SetCOMAKCostFunctionParameters_clone(swigCPtr, this);
    return (cPtr == 0) ? null : new SetCOMAKCostFunctionParameters(cPtr, true);
  }

  public String getConcreteClassName() {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getConcreteClassName(swigCPtr, this);
  }

  /**
   * Default constructor.
   */
  public SetCOMAKCostFunctionParameters() {
    this(opensimJAMJNI.new_SetCOMAKCostFunctionParameters__SWIG_0(), true);
  }
   ...
   */
  public SetCOMAKCostFunctionParameters(String aFileName, boolean aUpdateFromXMLNode) throws java.io.IOException {
    this(opensimJAMJNI.new_SetCOMAKCostFunctionParameters__SWIG_1(aFileName, aUpdateFromXMLNode), true);
  }
   ...
   * 
   */
  public SetCOMAKCostFunctionParameters(String aFileName) throws java.io.IOException {
    this(opensimJAMJNI.new_SetCOMAKCostFunctionParameters__SWIG_2(aFileName), true);
  }
   ...
   */
  public SetCOMAKCostFunctionParameters(SetCOMAKCostFunctionParameters aSet) {
    this(opensimJAMJNI.new_SetCOMAKCostFunctionParameters__SWIG_3(SetCOMAKCostFunctionParameters.getCPtr(aSet), aSet), true);
  }
  ...
  public void setupGroups() {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_setupGroups(swigCPtr, this);
  }
  ...
  public void setMemoryOwner(boolean aTrueFalse) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_setMemoryOwner(swigCPtr, this, aTrueFalse);
  }
  ...
  public boolean setSize(int aSize) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_setSize(swigCPtr, this, aSize);
  }
   ...
   */
  public int getSize() {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getSize(swigCPtr, this);
  }
   ...
   */
  public int getIndex(COMAKCostFunctionParameter aObject, int aStartIndex) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getIndex__SWIG_0(swigCPtr, this, COMAKCostFunctionParameter.getCPtr(aObject), aObject, aStartIndex);
  }
   ...
   * exists in the array, -1 is returned.
   */
  public int getIndex(COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getIndex__SWIG_1(swigCPtr, this, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }
  ...
  public int getIndex(String aName, int aStartIndex) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getIndex__SWIG_2(swigCPtr, this, aName, aStartIndex);
  }
  ...
  public int getIndex(String aName) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getIndex__SWIG_3(swigCPtr, this, aName);
  }
  ...
  public void getGroupNamesContaining(String aObjectName, ArrayStr rGroupNames) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_getGroupNamesContaining(swigCPtr, this, aObjectName, ArrayStr.getCPtr(rGroupNames), rGroupNames);
  }
   ...
   */
  public boolean adoptAndAppend(COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_adoptAndAppend(swigCPtr, this, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }
   ...
   * @return True if the append was successful, false otherwise.
   */
  public boolean cloneAndAppend(COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_cloneAndAppend(swigCPtr, this, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }
   ...
   */
  public boolean insert(int aIndex, COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_insert(swigCPtr, this, aIndex, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }
  ...
  public boolean remove(int aIndex) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_remove__SWIG_0(swigCPtr, this, aIndex);
  }
   ...
   * @return True if the removal was successful, false otherwise.
   */
  public boolean remove(COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_remove__SWIG_1(swigCPtr, this, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }

  public void clearAndDestroy() {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_clearAndDestroy(swigCPtr, this);
  }
   ...
   */
  public boolean set(int aIndex, COMAKCostFunctionParameter aObject, boolean preserveGroups) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_set__SWIG_0(swigCPtr, this, aIndex, COMAKCostFunctionParameter.getCPtr(aObject), aObject, preserveGroups);
  }
   ...
   * @return True if the set was successful, false otherwise.
   */
  public boolean set(int aIndex, COMAKCostFunctionParameter aObject) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_set__SWIG_1(swigCPtr, this, aIndex, COMAKCostFunctionParameter.getCPtr(aObject), aObject);
  }
   ...
   * @see operator[].
   */
  public COMAKCostFunctionParameter get(int aIndex) {
    return new COMAKCostFunctionParameter(opensimJAMJNI.SetCOMAKCostFunctionParameters_get__SWIG_0(swigCPtr, this, aIndex), false);
  }
   ...
   * @see getIndex()
   */
  public COMAKCostFunctionParameter get(String aName) {
    return new COMAKCostFunctionParameter(opensimJAMJNI.SetCOMAKCostFunctionParameters_get__SWIG_1(swigCPtr, this, aName), false);
  }
  ...
  public boolean contains(String aName) {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_contains(swigCPtr, this, aName);
  }
  ...
  public void getNames(ArrayStr rNames) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_getNames(swigCPtr, this, ArrayStr.getCPtr(rNames), rNames);
  }
  ...
  public int getNumGroups() {
    return opensimJAMJNI.SetCOMAKCostFunctionParameters_getNumGroups(swigCPtr, this);
  }
  ...
  public void addGroup(String aGroupName) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_addGroup(swigCPtr, this, aGroupName);
  }
  ...
  public void removeGroup(String aGroupName) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_removeGroup(swigCPtr, this, aGroupName);
  }
  ...
  public void renameGroup(String oldGroupName, String newGroupName) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_renameGroup(swigCPtr, this, oldGroupName, newGroupName);
  }
  ...
  public void addObjectToGroup(String aGroupName, String aObjectName) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_addObjectToGroup(swigCPtr, this, aGroupName, aObjectName);
  }
  ...
  public void getGroupNames(ArrayStr rGroupNames) {
    opensimJAMJNI.SetCOMAKCostFunctionParameters_getGroupNames(swigCPtr, this, ArrayStr.getCPtr(rGroupNames), rGroupNames);
  }
  ...
  public ObjectGroup getGroup(String aGroupName) {
    long cPtr = opensimJAMJNI.SetCOMAKCostFunctionParameters_getGroup__SWIG_0(swigCPtr, this, aGroupName);
  ...
  public ObjectGroup getGroup(int aIndex) {
    long cPtr = opensimJAMJNI.SetCOMAKCostFunctionParameters_getGroup__SWIG_1(swigCPtr, this, aIndex);
    return (cPtr == 0) ? null : new ObjectGroup(cPtr, false);
  }
