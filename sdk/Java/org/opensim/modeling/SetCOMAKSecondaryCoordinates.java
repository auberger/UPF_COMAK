 ...
 */
public class SetCOMAKSecondaryCoordinates extends OpenSimObject {
  private transient long swigCPtr;

  public SetCOMAKSecondaryCoordinates(long cPtr, boolean cMemoryOwn) {
    super(opensimJAMJNI.SetCOMAKSecondaryCoordinates_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(SetCOMAKSecondaryCoordinates obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        opensimJAMJNI.delete_SetCOMAKSecondaryCoordinates(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public static SetCOMAKSecondaryCoordinates safeDownCast(OpenSimObject obj) {
    long cPtr = opensimJAMJNI.SetCOMAKSecondaryCoordinates_safeDownCast(OpenSimObject.getCPtr(obj), obj);
    return (cPtr == 0) ? null : new SetCOMAKSecondaryCoordinates(cPtr, false);
  }

  public void assign(OpenSimObject aObject) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_assign(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject);
  }

  public static String getClassName() {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getClassName();
  }

  public OpenSimObject clone() {
    long cPtr = opensimJAMJNI.SetCOMAKSecondaryCoordinates_clone(swigCPtr, this);
    return (cPtr == 0) ? null : new SetCOMAKSecondaryCoordinates(cPtr, true);
  }

  public String getConcreteClassName() {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getConcreteClassName(swigCPtr, this);
  }

  /**
   * Default constructor.
   */
  public SetCOMAKSecondaryCoordinates() {
    this(opensimJAMJNI.new_SetCOMAKSecondaryCoordinates__SWIG_0(), true);
  }
   ...
   */
  public SetCOMAKSecondaryCoordinates(String aFileName, boolean aUpdateFromXMLNode) throws java.io.IOException {
    this(opensimJAMJNI.new_SetCOMAKSecondaryCoordinates__SWIG_1(aFileName, aUpdateFromXMLNode), true);
  }
   ...
   * 
   */
  public SetCOMAKSecondaryCoordinates(String aFileName) throws java.io.IOException {
    this(opensimJAMJNI.new_SetCOMAKSecondaryCoordinates__SWIG_2(aFileName), true);
  }
   ...
   */
  public SetCOMAKSecondaryCoordinates(SetCOMAKSecondaryCoordinates aSet) {
    this(opensimJAMJNI.new_SetCOMAKSecondaryCoordinates__SWIG_3(SetCOMAKSecondaryCoordinates.getCPtr(aSet), aSet), true);
  }
  ...
  public void setupGroups() {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_setupGroups(swigCPtr, this);
  }
  ...
  public void setMemoryOwner(boolean aTrueFalse) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_setMemoryOwner(swigCPtr, this, aTrueFalse);
  }
  ...
  public boolean setSize(int aSize) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_setSize(swigCPtr, this, aSize);
  }
   ...
   */
  public int getSize() {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getSize(swigCPtr, this);
  }
   ...
   */
  public int getIndex(COMAKSecondaryCoordinate aObject, int aStartIndex) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getIndex__SWIG_0(swigCPtr, this, COMAKSecondaryCoordinate.getCPtr(aObject), aObject, aStartIndex);
  }
   ...
   * exists in the array, -1 is returned.
   */
  public int getIndex(COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getIndex__SWIG_1(swigCPtr, this, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }
  ...
  public int getIndex(String aName, int aStartIndex) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getIndex__SWIG_2(swigCPtr, this, aName, aStartIndex);
  }
  ...
  public int getIndex(String aName) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getIndex__SWIG_3(swigCPtr, this, aName);
  }
  ...
  public void getGroupNamesContaining(String aObjectName, ArrayStr rGroupNames) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_getGroupNamesContaining(swigCPtr, this, aObjectName, ArrayStr.getCPtr(rGroupNames), rGroupNames);
  }
   ...
   */
  public boolean adoptAndAppend(COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_adoptAndAppend(swigCPtr, this, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }
   ...
   * @return True if the append was successful, false otherwise.
   */
  public boolean cloneAndAppend(COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_cloneAndAppend(swigCPtr, this, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }
   ...
   */
  public boolean insert(int aIndex, COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_insert(swigCPtr, this, aIndex, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }
  ...
  public boolean remove(int aIndex) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_remove__SWIG_0(swigCPtr, this, aIndex);
  }
   ...
   * @return True if the removal was successful, false otherwise.
   */
  public boolean remove(COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_remove__SWIG_1(swigCPtr, this, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }

  public void clearAndDestroy() {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_clearAndDestroy(swigCPtr, this);
  }
   ...
   */
  public boolean set(int aIndex, COMAKSecondaryCoordinate aObject, boolean preserveGroups) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_set__SWIG_0(swigCPtr, this, aIndex, COMAKSecondaryCoordinate.getCPtr(aObject), aObject, preserveGroups);
  }
   ...
   * @return True if the set was successful, false otherwise.
   */
  public boolean set(int aIndex, COMAKSecondaryCoordinate aObject) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_set__SWIG_1(swigCPtr, this, aIndex, COMAKSecondaryCoordinate.getCPtr(aObject), aObject);
  }
   ...
   * @see operator[].
   */
  public COMAKSecondaryCoordinate get(int aIndex) {
    return new COMAKSecondaryCoordinate(opensimJAMJNI.SetCOMAKSecondaryCoordinates_get__SWIG_0(swigCPtr, this, aIndex), false);
  }
   ...
   * @see getIndex()
   */
  public COMAKSecondaryCoordinate get(String aName) {
    return new COMAKSecondaryCoordinate(opensimJAMJNI.SetCOMAKSecondaryCoordinates_get__SWIG_1(swigCPtr, this, aName), false);
  }
  ...
  public boolean contains(String aName) {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_contains(swigCPtr, this, aName);
  }
  ...
  public void getNames(ArrayStr rNames) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_getNames(swigCPtr, this, ArrayStr.getCPtr(rNames), rNames);
  }
  ...
  public int getNumGroups() {
    return opensimJAMJNI.SetCOMAKSecondaryCoordinates_getNumGroups(swigCPtr, this);
  }
  ...
  public void addGroup(String aGroupName) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_addGroup(swigCPtr, this, aGroupName);
  }
  ...
  public void removeGroup(String aGroupName) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_removeGroup(swigCPtr, this, aGroupName);
  }
  ...
  public void renameGroup(String oldGroupName, String newGroupName) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_renameGroup(swigCPtr, this, oldGroupName, newGroupName);
  }
  ...
  public void addObjectToGroup(String aGroupName, String aObjectName) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_addObjectToGroup(swigCPtr, this, aGroupName, aObjectName);
  }
  ...
  public void getGroupNames(ArrayStr rGroupNames) {
    opensimJAMJNI.SetCOMAKSecondaryCoordinates_getGroupNames(swigCPtr, this, ArrayStr.getCPtr(rGroupNames), rGroupNames);
  }
  ...
  public ObjectGroup getGroup(String aGroupName) {
    long cPtr = opensimJAMJNI.SetCOMAKSecondaryCoordinates_getGroup__SWIG_0(swigCPtr, this, aGroupName);
  ...
  public ObjectGroup getGroup(int aIndex) {
    long cPtr = opensimJAMJNI.SetCOMAKSecondaryCoordinates_getGroup__SWIG_1(swigCPtr, this, aIndex);
    return (cPtr == 0) ? null : new ObjectGroup(cPtr, false);
  }
